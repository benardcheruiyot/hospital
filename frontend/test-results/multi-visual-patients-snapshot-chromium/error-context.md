...
- Name: multi-visual.spec.ts >> patients snapshot
- Location: tests\playwright\multi-visual.spec.ts:28:3

# Error details

```
Error: A snapshot doesn't exist at C:\Users\bcher\Desktop\hospital-digital-platform\frontend\tests\playwright\multi-visual.spec.ts-snapshots\patients-full-chromium-win32.png, writing actual.
```
